...
def sanitize_domain(domain_str: str) -> List:
    """Sanitize and validate Odoo domain string"""
    try:
...
def sanitize_fields(fields_str: str) -> List:
    """Sanitize and validate fields string"""
    try:
...
def validate_model_name(model_name: str) -> bool:
    ...
    # Odoo model names follow pattern: module.model (e.g., hr.employee)
    pattern = r'^[a-z_][a-z0-9_]*(\.[a-z_][a-z0-9_]*)* from user token"""
